...
const AllUserManagement = () => {
  ...
  const [columnsNames] = useState(["First Name" , "Last Name" , "Email" , "Username" , "Actions"]);
  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        data={data}
        />
        <h5 className={styles.mainTitle}>Users</h5>
        <div className="d-flex justify-content-around w-50">
          <div style={{display : csvDownload ? "" : "none"}}>
               <CsvDownload 
          data={downloadData} 
          filename="sharpz-users.csv" 
          style={{ 
              boxShadow:"inset 0px 1px 0px 0px #157AF6",
              background:"linear-gradient(to bottom, #157AF6 5%, #157AF6 100%)",
              ...
              padding:"6px 24px",
              textDecoration:"none",
              textShadow:"0px 1px 0px #157AF6",
              marginRight: '25x !important'
              }}
              >
                Download CSV
              </CsvDownload>
          ...
          <div className={styles.accountSearch}>
            <SearchField
              ...
              type="search"
              name="name"
              onKeyPress={(e) => searchUser(e?.target?.value)}
              onPress={(e) => searchUser(e?.target?.value)}
              onHandelChange={(e) => onChangeSearchValue(e?.target?.value)}
            />
          </div>
