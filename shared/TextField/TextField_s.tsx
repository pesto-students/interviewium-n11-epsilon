...
import { FieldProps } from '../../utilities/types/shared_types'
import styles from './TextField.module.scss'

const TextField_s = ({ disabled=false, name, label_text, placeholder, error, touched, value, handleChange, handleBlur, type, endAdor=false , startAdor=false}: FieldProps) => {
 ...
 return (<div className={styles.commonInputfields}><div className={`${(focused) ? styles.touched_label_text:(error && touched)?styles.error_label_text:styles.label_text}`}>{label_text}</div>
    <TextField
      ...
      InputProps={{
        ...
        classes:{notchedOutline:styles.no_border}
      }}
    />
